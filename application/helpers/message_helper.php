...
define('CLEAR_CREDIT', 'Succesfully cleared all credits.');
define('ROLL_BACK', 'Succesfully roll back this transaction.');
...
define('USER', 'letstalkaccounting');
define('SYSTEM_NAME','Lets Talk');
define('SYSTEM_ALT','Lets Talk');
define('SYSTEM_MODULE', 'Accounting');
