      ...
      <div flex class="hide-scroll">
          <nav class="scroll nav-light">
              ...
              <ul class="nav" ui-nav>
                ...
                <li class='<?=(sidebar($sidebar, ['credit'])) ? 'active' : ''?>'> 
                ...
                <li class='<?=(sidebar($sidebar, ['accounting_logs'])) ? 'active' : ''?>'> 
                  <a href="<?= base_url()?>accounting_logs" >
                    <span class="nav-icon">
                      <i class="fa fa-book">
                      </i>
                    </span>
                    <span class="nav-text">Accounting logs</span>
                  </a>
                </li>       
              </ul>
          </nav>
