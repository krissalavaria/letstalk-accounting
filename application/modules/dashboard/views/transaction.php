...
<div class="padding">	
	<div class="row">		
		<div class="box box-body">
			<a class="btn btn-primary pull-right" href="<?=@base_url().'dashboard/open-employee?token='.$token?>" id=""> <i class="fa fa-arrow-left"></i>	Back</a>
			<h2><?=@$user_details->first_name.' '.@$user_details->middle_name.' '.@$user_details->last_name.' - Transaction'?></h2>
				<div class="row">
                    <div class="col-md-6">
						<form role="form">
