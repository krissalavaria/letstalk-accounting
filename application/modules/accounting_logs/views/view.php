...
<div class="padding">	
	<div class="row">		
		<div class="box box-body">
			<a class="btn btn-primary pull-right" href="<?=@base_url().'accounting_logs'?>" id=""> <i class="fa fa-arrow-left"></i>	Back</a>
			<h2><?=@$user_details->first_name.' '.@$user_details->middle_name.' '.@$user_details->last_name.' - Accounting logs'?></h2>
				<div class="row">
                    <div class="col-md-6">
						<form role="form">
...
var credit_load = () =>{
    ...
    $.ajax({
        url: baseUrl + 'accounting_logs/list-transaction',
        type: "POST",
        data: {
            token : token
        },
